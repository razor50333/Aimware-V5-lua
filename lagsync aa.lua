...
function YawHandler()
    ...
    if yawamount:GetValue() > 0 then
        gui.SetValue("rbot.antiaim.yaw",yawamount:GetValue()-180);
    else
        gui.SetValue("rbot.antiaim.yaw",yawamount:GetValue()+180);
    end
    
    if not inverted then
        gui.SetValue("rbot.antiaim.lbyoverride",fakeamount:GetValue()/100*60*-1);
        gui.SetValue("rbot.antiaim.desync",fakeamount:GetValue()/100*58);
    else
        gui.SetValue("rbot.antiaim.lbyoverride",fakeamount:GetValue()/100*60);
        gui.SetValue("rbot.antiaim.desync",fakeamount:GetValue()/100*58*-1);
    end
